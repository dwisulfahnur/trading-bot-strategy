...
STRATEGY_PARAMS: dict[str, list[dict]] = {
    "momentum_candle": [
        ...
        {"name": "trade_direction",  "type": "str",   "default": "both",   "options": ["both", "long_only", "short_only"]},
        {"name": "long_sl_tp_mode",  "type": "str",   "default": "candle", "options": ["candle", "pips"]},
        {"name": "long_sl_mult",     "type": "float", "default": 1.0,  "min": 0.5, "max": 3.0,      "step": 0.1},
        {"name": "long_tp_mult",     "type": "float", "default": 1.0,  "min": 0.5, "max": 3.0,      "step": 0.1},
        {"name": "long_sl_pips",     "type": "float", "default": 200.0, "min": 10.0, "max": 5000.0,  "step": 10.0},
        {"name": "long_tp_pips",     "type": "float", "default": 400.0, "min": 10.0, "max": 10000.0, "step": 10.0},
        {"name": "short_sl_tp_mode", "type": "str",   "default": "candle", "options": ["candle", "pips"]},
        {"name": "short_sl_mult",    "type": "float", "default": 1.0,  "min": 0.5, "max": 3.0,      "step": 0.1},
        {"name": "short_tp_mult",    "type": "float", "default": 1.0,  "min": 0.5, "max": 3.0,      "step": 0.1},
        {"name": "short_sl_pips",    "type": "float", "default": 200.0, "min": 10.0, "max": 5000.0,  "step": 10.0},
        {"name": "short_tp_pips",    "type": "float", "default": 400.0, "min": 10.0, "max": 10000.0, "step": 10.0},
    ...
    "william_fractals": [
        ...
        {"name": "trade_direction",    "type": "str",   "default": "both",
         "options": ["both", "long_only", "short_only"]},
        # Long (buy) SL/TP
        {"name": "long_sl_tp_mode",    "type": "str",   "default": "rr",  "options": ["rr", "pips"]},
        {"name": "long_rr_ratio",      "type": "float", "default": 1.5,   "min": 0.5,  "max": 5.0,      "step": 0.1},
        {"name": "long_sl_pips",       "type": "float", "default": 200.0, "min": 10.0, "max": 5000.0,   "step": 10.0},
        {"name": "long_tp_pips",       "type": "float", "default": 400.0, "min": 10.0, "max": 10000.0,  "step": 10.0},
        # Short (sell) SL/TP
        {"name": "short_sl_tp_mode",   "type": "str",   "default": "rr",  "options": ["rr", "pips"]},
        {"name": "short_rr_ratio",     "type": "float", "default": 1.5,   "min": 0.5,  "max": 5.0,      "step": 0.1},
        {"name": "short_sl_pips",      "type": "float", "default": 200.0, "min": 10.0, "max": 5000.0,   "step": 10.0},
        {"name": "short_tp_pips",      "type": "float", "default": 400.0, "min": 10.0, "max": 10000.0,  "step": 10.0},
    ...
    "breakout_strategy": [
        ...
        {"name": "trade_direction",  "type": "str", "default": "both", "options": ["both", "long_only", "short_only"]},
        {"name": "long_sl_tp_mode",  "type": "str",   "default": "rr",  "options": ["rr", "pips"]},
        {"name": "long_rr_ratio",    "type": "float", "default": 2.0,   "min": 0.5,  "max": 5.0,      "step": 0.1},
        {"name": "long_sl_mode",     "type": "str",   "default": "structure", "options": ["structure", "signal_candle"]},
        {"name": "long_sl_pips",     "type": "float", "default": 200.0, "min": 10.0, "max": 5000.0,   "step": 10.0},
        {"name": "long_tp_pips",     "type": "float", "default": 400.0, "min": 10.0, "max": 10000.0,  "step": 10.0},
        {"name": "short_sl_tp_mode", "type": "str",   "default": "rr",  "options": ["rr", "pips"]},
        {"name": "short_rr_ratio",   "type": "float", "default": 2.0,   "min": 0.5,  "max": 5.0,      "step": 0.1},
        {"name": "short_sl_mode",    "type": "str",   "default": "structure", "options": ["structure", "signal_candle"]},
        {"name": "short_sl_pips",    "type": "float", "default": 200.0, "min": 10.0, "max": 5000.0,   "step": 10.0},
        {"name": "short_tp_pips",    "type": "float", "default": 400.0, "min": 10.0, "max": 10000.0,  "step": 10.0},
    ...
    "pip_breakout": [
        {"name": "level_detector",     "type": "str",   "default": "rolling", "options": ["rolling", "fractal"]},
        {"name": "lookback_bars",      "type": "int",   "default": 20,    "min": 5,     "max": 200},
        {"name": "fractal_n_before",   "type": "int",   "default": 5,     "min": 1,     "max": 20},
        {"name": "fractal_n_after",    "type": "int",   "default": 5,     "min": 1,     "max": 20},
        {"name": "trade_direction",   "type": "str",   "default": "both",  "options": ["both", "long_only", "short_only"]},
        {"name": "long_sl_tp_mode",   "type": "str",   "default": "pips",  "options": ["pips", "pct", "atr"]},
        {"name": "long_sl_pips",      "type": "float", "default": 200.0, "min": 10.0,  "max": 5000.0,  "step": 10.0},
        {"name": "long_tp_pips",      "type": "float", "default": 400.0, "min": 10.0,  "max": 10000.0, "step": 10.0},
        {"name": "long_sl_pct",       "type": "float", "default": 1.0,   "min": 0.01,  "max": 20.0,    "step": 0.01},
        {"name": "long_tp_pct",       "type": "float", "default": 2.0,   "min": 0.01,  "max": 50.0,    "step": 0.01},
        {"name": "long_atr_sl_mult",  "type": "float", "default": 1.5,   "min": 0.1,   "max": 10.0,    "step": 0.1},
        {"name": "long_atr_tp_mult",  "type": "float", "default": 3.0,   "min": 0.1,   "max": 20.0,    "step": 0.1},
        {"name": "short_sl_tp_mode",  "type": "str",   "default": "pips",  "options": ["pips", "pct", "atr"]},
        {"name": "short_sl_pips",     "type": "float", "default": 200.0, "min": 10.0,  "max": 5000.0,  "step": 10.0},
        {"name": "short_tp_pips",     "type": "float", "default": 400.0, "min": 10.0,  "max": 10000.0, "step": 10.0},
        {"name": "short_sl_pct",      "type": "float", "default": 1.0,   "min": 0.01,  "max": 20.0,    "step": 0.01},
        {"name": "short_tp_pct",      "type": "float", "default": 2.0,   "min": 0.01,  "max": 50.0,    "step": 0.01},
        {"name": "short_atr_sl_mult", "type": "float", "default": 1.5,   "min": 0.1,   "max": 10.0,    "step": 0.1},
        {"name": "short_atr_tp_mult", "type": "float", "default": 3.0,   "min": 0.1,   "max": 20.0,    "step": 0.1},
        {"name": "atr_period",        "type": "int",   "default": 14,    "min": 5,     "max": 100},
        {"name": "entry_mode",         "type": "str",   "default": "close",
         "options": ["close", "touch"]},
        {"name": "entry_offset_pips",  "type": "float", "default": 0.0,   "min": 0.0,   "max": 500.0,   "step": 1.0},
        {"name": "pending_cancel",     "type": "str",   "default": "max_bars",
         "options": ["none", "max_bars", "sl_break", "both"]},
        {"name": "max_pending_bars",   "type": "int",   "default": 10,    "min": 1,     "max": 100},
        {"name": "pending_cancel_buffer_pips", "type": "float", "default": 0.0, "min": 0.0, "max": 500.0, "step": 1.0},
        {"name": "ema_period",         "type": "int",   "default": 200,   "min": 10,    "max": 500},
        {"name": "ema_fast_period", "type": "int",   "default": 50,    "min": 5,     "max": 300},
        {"name": "ema_timeframe",   "type": "str",   "default": "same",
         "options": ["same", "M1", "M5", "M15", "M30", "H1", "H4", "D1"]},
    ...
    "n_structure": [
        ...
        {"name": "long_sl_tp_mode",  "type": "str",   "default": "rr",  "options": ["rr", "pips"]},
        {"name": "long_rr_ratio",    "type": "float", "default": 2.0,   "min": 0.5,  "max": 5.0,      "step": 0.1},
        {"name": "long_sl_mode",     "type": "str",   "default": "swing_midpoint",
        ...
        {"name": "short_sl_tp_mode", "type": "str",   "default": "rr",  "options": ["rr", "pips"]},
        {"name": "short_rr_ratio",   "type": "float", "default": 2.0,   "min": 0.5,  "max": 5.0,      "step": 0.1},
        {"name": "short_sl_mode",    "type": "str",   "default": "swing_midpoint",
         "options": ["swing_midpoint", "swing_point", "signal_candle"]},
        {"name": "short_sl_pips",    "type": "float", "default": 200.0, "min": 10.0, "max": 5000.0,   "step": 10.0},
        {"name": "short_tp_pips",    "type": "float", "default": 400.0, "min": 10.0, "max": 10000.0,  "step": 10.0},
        {"name": "pending_cancel",    "type": "str",   "default": "max_bars",
