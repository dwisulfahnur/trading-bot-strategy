...
STRATEGY_PARAMS: dict[str, list[dict]] = {
    ...
    "range_breakout": [
        # Range definition
        {"name": "range_lookback",  "type": "int",   "default": 20,    "min": 5,    "max": 100},
        {"name": "range_mode",      "type": "str",   "default": "rolling",
         "options": ["rolling", "fixed"]},
        {"name": "atr_period",      "type": "int",   "default": 14,    "min": 5,    "max": 50},
        {"name": "atr_multiplier",  "type": "float", "default": 0.0,   "min": 0.0,  "max": 10.0, "step": 0.5},
        # Entry
        {"name": "breakout_type",   "type": "str",   "default": "close",
         "options": ["close", "hl"]},
        {"name": "allow_reentry",   "type": "bool",  "default": False},
        # Exit
        {"name": "sl_buffer",       "type": "float", "default": 0.0,   "min": 0.0,  "max": 5.0,  "step": 0.1},
        {"name": "rr_ratio",        "type": "float", "default": 2.0,   "min": 0.5,  "max": 5.0,  "step": 0.1},
        # Trend filter
        {"name": "ema_period",      "type": "int",   "default": 200,   "min": 0,    "max": 500},
        {"name": "ema_timeframe",   "type": "str",   "default": "same",
         "options": ["same", "M1", "M5", "M15", "H1", "H4", "D1"]},
        # Session filter
        {"name": "sessions",        "type": "str",   "default": "all",
    ...
    "market_structure_fib": [
        {"name": "swing_n",           "type": "int",   "default": 5,     "min": 2,    "max": 20},
        {"name": "fib_entry",         "type": "float", "default": 0.618, "min": 0.1,  "max": 0.9,  "step": 0.001},
        {"name": "sl_mode",           "type": "str",   "default": "swing_point",
         "options": ["swing_point", "signal_candle"]},
        {"name": "rr_ratio",          "type": "float", "default": 2.0,   "min": 0.5,  "max": 5.0,  "step": 0.1},
        {"name": "pending_cancel",    "type": "str",   "default": "both",
         "options": ["none", "max_bars", "hl_break", "both"]},
        {"name": "max_pending_bars",  "type": "int",   "default": 20,    "min": 1,    "max": 100},
        # EMA trend filter
        {"name": "ema_period",        "type": "int",   "default": 200,   "min": 10,   "max": 500},
        {"name": "ema_timeframe",     "type": "str",   "default": "same",
         "options": ["same", "M1", "M5", "M15", "H1", "H4", "D1"]},
    ...
    "fair_value_gap": [
        ...
        {"name": "ema_timeframe", "type": "str",   "default": "same",
         "options": ["same", "M1", "M5", "M15", "H1", "H4", "D1"]},
        # ── FVG detection ───────────────────────────────────────────────────
        {"name": "fvg_min_size",  "type": "float", "default": 0.0,  "min": 0.0, "max": 50.0, "step": 0.5},
        {"name": "max_fvg_bars",  "type": "int",   "default": 20,   "min": 1,   "max": 100},
        {"name": "min_sl_pips",   "type": "float", "default": 5.0,  "min": 0.0, "max": 50.0, "step": 0.5},
        # ── Swing structure (for swing_hl SL mode) ──────────────────────────
        {"name": "swing_n_before", "type": "int",  "default": 5,    "min": 1,   "max": 20},
        {"name": "swing_n_after",  "type": "int",  "default": 5,    "min": 1,   "max": 20},
        # ── Entry & Exit ────────────────────────────────────────────────────
        {"name": "rr_ratio",      "type": "float", "default": 2.0,  "min": 0.5, "max": 10.0, "step": 0.1},
        {"name": "entry_mode",    "type": "str",   "default": "zone_mid",
         "options": ["zone_top", "zone_mid", "zone_bottom"]},
        {"name": "sl_mode",       "type": "str",   "default": "swing_hl",
         "options": ["swing_hl", "fvg_edge", "signal_candle", "impulse_candle"]},
        # ── Session filter ──────────────────────────────────────────────────
        {"name": "sessions",      "type": "str",   "default": "all",
         "options": ["all", "asia", "london", "newyork",
                     "asia_london", "london_newyork", "asia_newyork",
...
DISPLAY_NAMES: dict[str, str] = {
    ...
    "market_structure_fib":  "Market Structure + Fibonacci",
