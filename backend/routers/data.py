...
STRATEGY_PARAMS: dict[str, list[dict]] = {
    ...
    "pip_breakout": [
        ...
        {"name": "sl_tp_mode",         "type": "str",   "default": "pips", "options": ["pips", "pct", "atr"]},
        {"name": "sl_pips",            "type": "float", "default": 200.0, "min": 10.0,  "max": 5000.0,  "step": 10.0},
        {"name": "tp_pips",            "type": "float", "default": 400.0, "min": 10.0,  "max": 10000.0, "step": 10.0},
        {"name": "sl_pct",             "type": "float", "default": 1.0,   "min": 0.01,  "max": 20.0,    "step": 0.01},
        {"name": "tp_pct",             "type": "float", "default": 2.0,   "min": 0.01,  "max": 50.0,    "step": 0.01},
        {"name": "atr_period",         "type": "int",   "default": 14,    "min": 5,     "max": 100},
        {"name": "atr_sl_mult",        "type": "float", "default": 1.5,   "min": 0.1,   "max": 10.0,    "step": 0.1},
        {"name": "atr_tp_mult",        "type": "float", "default": 3.0,   "min": 0.1,   "max": 20.0,    "step": 0.1},
    ...
    "n_structure": [
        ...
        {"name": "swing_n_before",    "type": "int",   "default": 5,     "min": 1,    "max": 20},
        {"name": "swing_n_after",     "type": "int",   "default": 5,     "min": 1,    "max": 20},
        {"name": "sl_tp_mode",        "type": "str",   "default": "rr",  "options": ["rr", "pips"]},
        {"name": "rr_ratio",          "type": "float", "default": 2.0,   "min": 0.5,  "max": 5.0,  "step": 0.1},
